...
the last:
\begin{enumerate}[leftmargin=1.4em,itemsep=2pt]
\item \textbf{Selection forward} --- apply the same block-outer restructuring to the forward pass
(still GQA-padded, a smaller $\sim$7.6\% of the step) now that the backward is done.
